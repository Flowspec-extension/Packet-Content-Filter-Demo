...
#define FLOWSPEC_TYPE_PAYLOAD   14
#define FLOWSPEC_TYPE_MAX		15

#define FLOWSPEC_TYPE_PAYLD_HL	4
#define FLOWSPEC_TYPE_PAYLD_TYPE_OFFSET		0
#define FLOWSPEC_TYPE_PAYLD_OFFSET_OFFSET	1
#define FLOWSPEC_TYPE_PAYLD_CONTL_OFFSET	3
