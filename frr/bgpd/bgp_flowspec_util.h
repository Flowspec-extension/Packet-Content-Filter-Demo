...
#define BGP_FLOWSPEC_PAYLD_HL	4
#define BGP_FLOWSPEC_PAYLD_TYPE_OFFSET		0
#define BGP_FLOWSPEC_PAYLD_OFFSET_OFFSET	1
#define BGP_FLOWSPEC_PAYLD_CONTL_OFFSET	3
...
extern int bgp_flowspec_payload_decode(enum bgp_flowspec_util_nlri_t type,
				  uint8_t *nlri_ptr,
				  uint32_t max_len,
				  void *result, int *error);
