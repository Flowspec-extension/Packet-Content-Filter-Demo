...
int bgp_iptable_init(void)
{
	system("sudo iptables -N FRR_FORWARD");
	system("sudo iptables -F FRR_FORWARD");
	system("sudo iptables -D FORWARD -j FRR_FORWARD");
	system("sudo iptables -I FORWARD -j FRR_FORWARD");
	return 0;
}

int bgp_iptable_free(void)
{
	system("sudo iptables -D FORWARD -j FRR_FORWARD");
	system("sudo iptables -F FRR_FORWARD");
	system("sudo iptables -X FRR_FORWARD");
	return 0;
}
